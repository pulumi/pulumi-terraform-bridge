	...
	cases := []tc{
		...
		},
		{
			...
			expected: map[string]*pulumirpc.PropertyDiff{
				...
				"items[1].weight": &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
			},
			ignoreChanges: []string{"items[*].weight"},
		},
		{
			...
			expected: map[string]*pulumirpc.PropertyDiff{
				"items[0].weight": &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
				"items[1].weight": &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
				"items[2]":        &pulumirpc.PropertyDiff{},
			},
		},
		{
			...
			expectedDiffChanges: pulumirpc.DiffResponse_DIFF_SOME,
			expected: map[string]*pulumirpc.PropertyDiff{
				"items.other": &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
			},
		},
		{
			...
			expected: map[string]*pulumirpc.PropertyDiff{
				"items.other":  &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
				"items.weight": &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
			},
		},
		{
			...
			expected: map[string]*pulumirpc.PropertyDiff{
				"items.other":  &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
				"items.weight": &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
				"items.third":  &pulumirpc.PropertyDiff{},
			},
		},
		{
			name: "SetNestedField",
			...
			expected: map[string]*pulumirpc.PropertyDiff{
				...
				"items[0]":        &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_DELETE},
				"items[1].weight": &pulumirpc.PropertyDiff{Kind: pulumirpc.PropertyDiff_UPDATE},
			},
		},
		{
