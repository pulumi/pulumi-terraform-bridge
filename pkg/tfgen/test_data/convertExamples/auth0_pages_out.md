...
public class App {
    ...
    public static void stack(Context ctx) {
        var myPages = new Auth0_pages("myPages", Auth0_pagesArgs.builder()
            ...
            .changePassword(%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
            .guardianMfa(%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
