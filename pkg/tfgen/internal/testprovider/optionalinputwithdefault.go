...
func ProviderRequiredInputWithDefaultFunc() tfbridge.ProviderInfo {
	return tfbridge.ProviderInfo{
		P:           shimv2.NewProvider(testproviderdata.ProviderRequiredInputWithDefaultFunc()),
		Name:        "testprovider",
		Description: "A Pulumi package to safely use testprovider in Pulumi programs.",
