...
func ProviderLargeTokens() tfbridge.ProviderInfo {
	return tfbridge.ProviderInfo{
		P:           shimv2.NewProvider(testproviderdata.ProviderLargeTokens()),
		Name:        "aws",
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			"aws_quicksight_template": {
				Tok: tfbridge.MakeResource("aws", "quicksight", "Template"),
			},
		},
	}
}
