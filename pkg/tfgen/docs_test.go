...
func TestFixupPropertyReference(t *testing.T) {
	...
	tests := []testCase{
		...
		{
			name:     "property name that somehow has newlines",
			input:    "Random permutation of the list of strings given in `input`",
			expected: "Random permutation of the list of strings given in <span pulumi-lang-nodejs=\"`input`\" pulumi-lang-dotnet=\"`input`\"\npulumi-lang-go=\"`input`\" pulumi-lang-python=\"`input`\" pulumi-lang-yaml=\"`input`\"\npulumi-lang-java=\"`input`\">`input`</span>.",
			ctx: infoContext{
				pkg:  "random",
				info: tfbridge.ProviderInfo{},
			},
		...
		},
		{
			...
			expected: "Use <span pulumi-lang-typescript=\"`random.RandomPet`\" pulumi-lang-dotnet=\"`random.RandomPet`\" pulumi-lang-go=\"`RandomPet`\" pulumi-lang-python=\"`RandomPet`\" pulumi-lang-yaml=\"`random.RandomPet`\" pulumi-lang-java=\"`random.RandomPet`\">`random.RandomPet`</span> and <span pulumi-lang-typescript=\"`random.RandomId`\" pulumi-lang-dotnet=\"`random.RandomId`\" pulumi-lang-go=\"`RandomId`\" pulumi-lang-python=\"`random_id`\" pulumi-lang-yaml=\"`random.RandomId`\" pulumi-lang-java=\"`random.RandomId`\">`random.RandomId`</span> together.",
			ctx: infoContext{
				pkg: "random",
				info: tfbridge.ProviderInfo{
					Resources: map[string]*tfbridge.ResourceInfo{
