...
// ToCtyType extracts the underlying cty.Type from a Type, if possible.
// Returns the cty.Type and true if successful, or an invalid cty.Type and false otherwise.
func ToCtyType(t Type) (cty.Type, bool) {
