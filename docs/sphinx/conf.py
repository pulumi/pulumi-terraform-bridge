...
# -- Project information -----------------------------------------------------
project = "Pulumi Terraform Bridge"
...
intersphinx_mapping = {
    ...
    "pulumi": ("https://pulumi-developer-docs.readthedocs.io/latest/", None),
}
...
html_title = "Pulumi Terraform Bridge Developer Documentation"
...
html_theme_options = {
    ...
    "repository_url": "https://github.com/pulumi/pulumi-terraform-bridge",
