...
replace (
	...
	github.com/hashicorp/terraform-plugin-sdk/v2/hcl2shim => ./pkg/hcl2shim
)
...
require (
	...
	// Remember to update the version that sits in the hcl2shim package as this gives access to
	// internal functions
	github.com/hashicorp/terraform-plugin-sdk/v2 v2.13.0
	github.com/hashicorp/terraform-plugin-sdk/v2/hcl2shim v0.0.0
