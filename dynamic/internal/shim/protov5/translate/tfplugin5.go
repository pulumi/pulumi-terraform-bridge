...
func attributePath(i *tfplugin5.AttributePath) *tftypes.AttributePath {
	...
	arr := applyArray(i.Steps, func(v *tfplugin5.AttributePath_Step) tftypes.AttributePathStep {
	...
	return tftypes.NewAttributePathWithSteps(arr)
}
...
func ValidateResourceTypeConfigRequest(
	i *tfprotov5.ValidateResourceTypeConfigRequest,
...
func ValidateResourceTypeConfigResponse(
	i *tfplugin5.ValidateResourceTypeConfig_Response,
...
func ValidateDataSourceConfigRequest(
	i *tfprotov5.ValidateDataSourceConfigRequest,
) *tfplugin5.ValidateDataSourceConfig_Request {
	if i == nil {
		return nil
	}
...
func ValidateDataSourceConfigResponse(
	i *tfplugin5.ValidateDataSourceConfig_Response,
) *tfprotov5.ValidateDataSourceConfigResponse {
	if i == nil {
		return nil
	}
