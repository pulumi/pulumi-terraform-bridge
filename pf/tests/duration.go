// Obtained from https://raw.githubusercontent.com/hashicorp/terraform-provider-aws/main/internal/framework/types/duration.go
// Retaining original LICENCE notice below.
//
