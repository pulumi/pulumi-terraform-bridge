...
func (a attribute) Type() shim.ValueType {
	switch {
	case a.attr.Type.Is(tftypes.Bool):
		return shim.TypeBool
	case a.attr.Type.Is(tftypes.Number):
	...
	case a.attr.Type.Is(tftypes.String):
		return shim.TypeString
	case a.attr.Type.Is(tftypes.List{}) || a.attr.Type.Is(tftypes.Set{}):
		return shim.TypeList
	case a.attr.Type.Is(tftypes.Map{}) || a.attr.Type.Is(tftypes.Object{}) || a.attr.NestedType != nil:
		return shim.TypeMap
	default:
